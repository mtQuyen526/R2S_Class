package constructors_and_access_modifiers.lab2;
...
public class TrainingManagement {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "4" -> {
                    ...
                    if (result.length == 0) System.out.println("np match");
                    else {
    ...
    private void displayAllTrainee() {
        if (count == 0) {
            System.out.println("No trainee yet");
            return;
        }
        System.out.println(header());
    ...
    private void updateTrainee(String id, Trainee newTrainee) {
        ...
        //giu nguyen id, update truong hop khac -- keep same id, update other field
